...
The primary robust summary and every screening/Pareto decision use only the configured main window (298.15–353.15 K by default). If `run_extended_sensitivity` is enabled, additional 278.15–373.15 K points are tagged `extended_sensitivity`, audited, and retained separately; they do not alter the primary thresholds or ranks.
