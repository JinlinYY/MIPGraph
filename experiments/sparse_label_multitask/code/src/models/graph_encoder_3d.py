...
class GraphEncoder3D(nn.Module):
    def __init__(
        ...
        strip_edge_geometry: bool = False,
    ) -> None:
        super().__init__()
        self.use_e3_invariant_geometry = use_e3_invariant_geometry
        self.strip_edge_geometry = strip_edge_geometry
    ...
    def forward(self, data):
        ...
        if self.strip_edge_geometry and raw_edge_attr.size(1) > 10:
            raw_edge_attr = raw_edge_attr.clone()
            raw_edge_attr[:, 10:] = 0.0
