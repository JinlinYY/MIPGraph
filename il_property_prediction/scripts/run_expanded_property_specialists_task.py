...
def main() -> None:
    ...
    output_root = project / "outputs" / "property_specialists_expanded_ilthermo_interpolated_seed42"
    ...
    with (output_root / "run4_stdout.log").open("w", encoding="utf-8") as stdout, (
        output_root / "run4_stderr.log"
